...
import { validateInputEmail, validateInputPhone, validateOnlyLetters, validatePassword ,validateCIN} from '../utils/validatesInput';
...
export const schema  = Yup.object().shape({
  ...
  cin: Yup.string().required('CIN is required').test('Cin', 'CIN is not valid', value => validateCIN(value)),
